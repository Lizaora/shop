...
const ProductSlide = ()=>{
    return (<div className="product-area pt-40 pb-70">
    <div className="container" style={{ paddingTop: "10em"}}>
      <div className="product-top-bar section-border mb-35">
        <div className="section-title-wrap">
          <h3 className="section-title section-bg-white">Nos offres du moment</h3>
        </div>
      </div>
      ...
      <OwlCarousel items={4}  loop margin={10}>
          ...
          <CardsProduct article={{pourcentage : "30",name:"bouqet",promo:"12"}}/>
        </OwlCarousel>
      </div>
    </div>
          ...
          <div className="col-md-5 col-sm-5 col-xs-12">
            ...
            <div className="product-thumbnail">
              <div className="thumb-menu nav nav-style" role="tablist">
                <OwlCarousel loop>
                <button className="active" data-bs-toggle="tab" data-bs-target="#pro-1"><img src="assets/img/product-details/product-detalis-s1.jpg" alt="" /></button>
            ...
            <div className="modal-pro-content">
              ...
              <div className="product-quantity">
                <div className="cart-plus-minus">
                  <input className="cart-plus-minus-box" type="text" name="qtybutton" defaultValue="02" />
                </div>
