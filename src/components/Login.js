...
<div className="testimonials-area bg-img pt-120 pb-115" style={{backgroundImage: 'url(assets/img/bg/bg-1.jpg)'}}>
        ...
        <OwlCarousel items={1}  loop  >
          <div className="single-testimonial text-center">
            ...
            <div className="testimonial-img">
              <img  alt="" style={{width :"47px"}} src="assets/img/icon-img/testi.png" />
            </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-xl-5 col-md-6">
              <div className="single-best-img">
                <img className="tilter" src="assets/img/banner/deal-1.jpeg" alt='' />
              </div>
            </div>
            <div className="col-lg-6 col-xl-7 col-md-6">
              <div className="deals-content text-center deal-mrg">
                <img className="sousimage" alt='' src="assets/img/icon-img/deals-2.png" />
                <h2>C'EST BIENTÔT LA SAINT VALENTIN</h2>
                <p>La fête des amoureux approche, c’est l’occasion de couvrir de tendres cadeaux votre moitié. Classique avec les roses rouges, ou plus original avec une composition florale unique, laissez parler votre cœur pour offrir à l’être aimé une attention dont il ou elle se souviendra longtemps </p>
...
<div className="brand-logo-area ptb-75">
  ...
  <div className="product-top-bar section-border mb-35">
      <div className="section-title-wrap">
        <h3 className="section-title section-bg-white">ils nous font confiance</h3>
      </div>
    </div>
